...
#define HUD_FRAME_BUFFER_HEIGHT				WIN_HEIGHT
#define MAIN_FRAME_BUFFER_WIDTH				WIN_WIDTH - HUD_FRAME_BUFFER_WIDTH
#define MAIN_FRAME_BUFFER_HEIGHT			WIN_HEIGHT
#define HUD_FRAME_BUFFER_X					MAIN_FRAME_BUFFER_WIDTH
#define HUD_FRAME_BUFFER_Y					0
#define RADAR_FRAME_BUFFER_X				HUD_FRAME_BUFFER_X
#define RADAR_FRAME_BUFFER_Y				120
#define RADAR_FRAME_BUFFER_WIDTH			HUD_FRAME_BUFFER_WIDTH
#define RADAR_FRAME_BUFFER_HEIGHT			WIN_HEIGHT - 250
